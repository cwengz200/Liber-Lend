...
public class Catologue {
    ...
    private Catologue(Catologue.Builder builder){
    ...
    public Catologue.Builder setTitle(String title) {
        this.Title= title;
        return this;
    }

    public Catologue.Builder setAuthor(String author) {
        this.Author = author;
        return this;
    }
    public  Catologue.Builder setPublisher(String publisher) {
        this.publisher = publisher;
        return this;
    }

    public  Catologue.Builder setISBN(String isbn) {
        this.ISBN =ISBN;
        return this;
    }

    public  Catologue.Builder setreviews(String reviews){
        this.reviews = reviews;
        return this;
    }
    public  Catologue.Builder setDescription(String descriptiony) {
